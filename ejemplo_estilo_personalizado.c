...
int main() {
    ...
    // Agregar opciones
    menu_agregar_opcion(menu, '1', "Ver información", opcion_mensaje, 
                       NULL, "Esta es una opción de ejemplo");
    menu_agregar_opcion(menu, '2', "Otra opción", opcion_mensaje, 
                       NULL, "Segunda opción del menú");
    menu_agregar_opcion(menu, '3', "Más opciones", opcion_mensaje, 
                       NULL, "Tercera opción disponible");
